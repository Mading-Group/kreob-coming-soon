        ...
        <div className="relative flex-1 flex flex-col items-center">
          <div className="max-w-[500px] lg:max-w-[700px] mt-16 px-4 pb-8 lg:px-0 lg:pb-0">
            ...
            <TextEffect
              ...
              delay={0.6}
              speedReveal={1.5}
              className="text-[#FEFCFB] text-xs sm:text-sm md:text-lg text-center mt-4"
            >
              KREOB réinvente le négoce agricole : une plateforme agile et
              connectée, conçue pour booster vos performances et redéfinir les
